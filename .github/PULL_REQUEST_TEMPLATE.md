<!-- Exiid Labs PR template. Agents: fill every section — this summary is what the reviewer reads instead of the diff. Keep the PR scoped to one change. -->
